 ...
 */
//WriteBuffer主要是对ByteBuffer进行了封装，使之在空间不够的时候自动扩容
public class WriteBuffer {
    ...
    public WriteBuffer putVarInt(int x) {
        DataUtil.writeVarInt(ensureCapacity(5), x);
        return this;
    }
    ...
    public WriteBuffer putVarLong(long x) {
        DataUtil.writeVarLong(ensureCapacity(10), x);
        return this;
    }
